            ...
            {userData ? (<>
                <div className="card mt-5 mb-5 ms-5 bg-light" style={{ width: "250px" }}>
                    <div className="card-body" onClick={togglePopup}>
                        ...
                        <div id={id} className="progress-bar" role="progressbar" style={{ "width": `${eventData.average_progress}%` }} aria-valuenow={`${eventData.average_progress}%`} aria-valuemin="0" aria-valuemax="100">Progress: {eventData.average_progress}%</div>
                    </div>
                    </div>
                </div>
                {showPopup && (
